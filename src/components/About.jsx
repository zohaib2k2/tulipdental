      ...
      <div className="bg-[#fffef1] flex items-center justify-center">
        <div className="max-w-7xl w-full grid md:grid-cols-2 gap-40 items-center md-20 pb-7">
          ...
          <div className="space-y-2">
            <div>
              <p className="text-slate-400 text-sm font-medium tracking-wider mb-1 pl-4">
                VERY WELCOME
              </p>
            ...
            <a href="https://wa.me/+31620144888?text=Hello, I would like to inquire and book an appointment">
